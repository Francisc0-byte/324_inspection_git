...
3. Quelle est la **branche principale** du projet ?
   ...
   - Branche principale distante : origin/main
### Partie 3 — Historique et commits

1. Quel est le message du **premier commit** du projet ?  
2. Trouvez le commit où une **clé API** a été ajoutée par erreur. Quel est son identifiant (hash court) ?  
3. Quel commit a ensuite corrigé cette erreur ?  
4. Trouvez le commit où le **titre de la page d'accueil** a été corrigé.  
5. Quel est le message du commit qui a **ajouté le fichier `CHANGELOG.md`** et quelle commande avez-vous utilisé ?
